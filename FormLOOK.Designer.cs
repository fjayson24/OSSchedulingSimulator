namespace OSProject
{
    partial class FormLOOK
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitle.Text = "LOOK Disk Scheduling";
            ...
            lblDirection.Location = new Point(450, 70);
            lblDirection.Name = "lblDirection";
            lblDirection.Text = "Direction:";

            cmbDirection.DropDownStyle = ComboBoxStyle.DropDownList;
            cmbDirection.Location = new Point(530, 67);
            cmbDirection.Size = new Size(100, 23);
