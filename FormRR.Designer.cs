namespace OSProject
{
    partial class FormRR
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTimeQuantum.Location = new Point(650, 70);
            lblTimeQuantum.Name = "lblTimeQuantum";
            lblTimeQuantum.Text = "Time Quantum (ms):";

            txtTimeQuantum.Location = new Point(750, 67);
            txtTimeQuantum.Size = new Size(60, 23);
            txtTimeQuantum.Text = "2";
